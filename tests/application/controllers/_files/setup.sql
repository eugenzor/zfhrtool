...
(1, 'Психологический тест', 3, '2010-03-30 01:26:49', 1, 15),
(2, 'Общий тест по PHP', 4, '2010-03-30 01:36:19', 2, 20),
(3, 'PHP (ООП)', 3, '2010-03-30 01:41:57', 2, 20);
...
(25, NULL, 18, 3, NULL, 'b63335f3ae5d9baf033fc0c202e1de04', NULL),
...
(32, '2010-07-22 12:53:46', 17, 2, 67, '92c2bc7eb520710774a9d2963c0899f7', NULL);
...
TRUNCATE TABLE `test_question_category`;
...
(8, 'категория XXX', 'это категория без зависимых вопросов', 1);
